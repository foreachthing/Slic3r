...
sub new {
    ...
    if (!&Wx::wxMSW) {
        ...
        if ($Slic3r::GUI::Settings->{_}{extended_context_toolbar}){
            for (qw(add remove reset arrange increase decrease rotateX90ccw rotateX90cw rotateY90ccw rotateY90cw rotateZ90ccw rotateZ90cw rotate45ccw rotate45cw changescale split cut layers settings)) {
